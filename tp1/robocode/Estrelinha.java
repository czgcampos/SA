...
/**
 * 
 * Estrelinha - inspired by BorderGuard
 * 
 ...
 * @since 1.9.0.0
 */
public class Estrelinha extends TeamRobot {
	...
	final Map<String, RobotData> enemyMap = new LinkedHashMap<String, RobotData>(5, 2, true);;
	...
	private void moveRobot() {
		...
		if (target != null) {
			...
			// 80 was getSentryBorderSize() before
			int borderRange = 80 - 20;
	...
	private void updateTarget() {
		...
		// se já não fazemos update há mais de 20 ticks, fazemos agr
		// ou não temos target agr
